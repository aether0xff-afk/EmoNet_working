...
- pareto_front: `True`
- feasible: `False`
- constraint_penalty: `1.937500`
- constraint_failures: `hit_max_ticks_ratio>0.8;mean_first_active_tick>20.0;late_ignition_ratio_ge_15>0.4`
- mean_branch_len: `104.2500`
- len1_ratio: `0.0000`
- hit_max_ticks_ratio: `1.0000`
- mean_first_active_tick: `23.7500`
- active_window_ratio: `0.8145`
...
- balanced_score: `30.6696`
- pareto_front: `True`
- feasible: `False`
- constraint_penalty: `2.105000`
- constraint_failures: `hit_max_ticks_ratio>0.8;mean_first_active_tick>20.0;late_ignition_ratio_ge_15>0.4`
- mean_branch_len: `100.9000`
- len1_ratio: `0.0000`
- hit_max_ticks_ratio: `1.0000`
- mean_first_active_tick: `27.1000`
- active_window_ratio: `0.7883`
...
### random:k_threshold_base=0.82;k_remem_base=1.05;k_decay=0.96;refractory_ticks=2;input_signal_clip=1.2;recent_activity_decay=0.2;hysteresis_threshold_gain=0.03;hysteresis_remem_gain=0.02;hysteresis_k_bonus=0.0;memory_decay=0.97;memory_k_mix=0.0;state_base_stim_mix=0.05

- balanced_score: `31.0491`
- pareto_front: `True`
- feasible: `False`
- constraint_penalty: `2.147500`
- constraint_failures: `hit_max_ticks_ratio>0.8;mean_first_active_tick>20.0;late_ignition_ratio_ge_15>0.4`
- mean_branch_len: `100.0500`
- len1_ratio: `0.0000`
- hit_max_ticks_ratio: `1.0000`
- mean_first_active_tick: `27.9500`
- active_window_ratio: `0.7816`
- params_json: `{"branch_end_window": 6, "branch_length_bonus": 0.35, "dopa_rewire_gain": 0.8, "global_recovery_rate": 0.1, "hysteresis_k_bonus": 0.0, "hysteresis_remem_gain": 0.02, "hysteresis_threshold_gain": 0.03, "input_signal_clip": 1.2, "input_topk": 2, "k_decay": 0.96, "k_remem_base": 1.05, "k_threshold_base": 0.82, "max_out_degree": 12, "max_ticks": 128, "mela_dropout_gain": 0.04, "memory_decay": 0.97, "memory_k_mix": 0.0, "memory_stim_mix": 0.25, "min_out_degree": 1, "min_ticks_before_converged": 6, "ne_remem_reduce_gain": 0.25, "ne_thresh_reduce_gain": 0.25, "recent_activity_decay": 0.2, "refractory_ticks": 2, "sero_prune_gain": 0.04, "state_base_stim_mix": 0.05, "state_bias_stim_mix": 0.05, "state_parent_stim_mix": 0.25, "state_self_stim_mix": 0.55, "topk_branches": 4}`
