...
DEFAULT_OFAT_STEPS: dict[str, Any] = {
    ...
    "refractory_ticks": 1,
    "input_topk": 1,
    "input_signal_clip": 0.25,
    "memory_decay": 0.003,
    "memory_stim_mix": 0.05,
    "memory_k_mix": 0.10,
    "state_self_stim_mix": 0.10,
    "state_parent_stim_mix": 0.10,
    "state_base_stim_mix": 0.10,
    "state_bias_stim_mix": 0.05,
    "recent_activity_decay": 0.10,
    "hysteresis_threshold_gain": 0.04,
    "hysteresis_remem_gain": 0.04,
    "hysteresis_k_bonus": 0.04,
    "max_out_degree": 2,
    "min_out_degree": 1,
